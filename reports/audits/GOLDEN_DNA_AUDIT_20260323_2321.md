# RAPORT W OPARCIU O ASERCJE W PEŁNI SYSTEMOWE DNA - 2026-03-23 23:25
...
|---|---|---|---|
| `national_rail_hub` | T0_MEGA_HUB | 1 | 34,659,694 |
| `hospital_clinical` | T1_NATIONAL_MAGNET | 11 | 18,227,298 |
| `national_stadium` | T1_NATIONAL_MAGNET | 6 | 16,775,365 |
| `university_campus` | T1_NATIONAL_MAGNET | 34 | 11,868,101 |
| `regional_rail_hub` | T1_NATIONAL_MAGNET | 4 | 6,708,819 |
| `industrial_zone` | T2_STRATEGIC_HUB | 239 | 4,904,162 |
| `commercial_zone` | T2_STRATEGIC_HUB | 57 | 4,700,014 |
| `shopping_mall` | T2_STRATEGIC_HUB | 37 | 3,848,562 |
| `logistics_hub` | T2_STRATEGIC_HUB | 1 | 3,611,793 |
| `student_dormitory` | T2_STRATEGIC_HUB | 9 | 3,387,325 |
| `supermarket` | T2_STRATEGIC_HUB | 145 | 2,488,752 |
| `government_central` | T2_STRATEGIC_HUB | 104 | 2,370,880 |
| `business_office` | T2_STRATEGIC_HUB | 160 | 2,105,252 |
| `marketplace` | T3_LOCAL_CORE | 12 | 801,581 |
| `education_high_school` | T3_LOCAL_CORE | 136 | 779,551 |
| `sports_centre` | T3_LOCAL_CORE | 51 | 534,968 |
| `social_support_mops` | T3_LOCAL_CORE | 42 | 512,213 |
| `culture_theatre` | T3_LOCAL_CORE | 42 | 406,352 |
| `health_clinic` | T3_LOCAL_CORE | 205 | 350,401 |
| `park_recreation` | T4_DAILY_SERVICE | 104 | 151,980 |
...
| Kategoria | Tier | Ilość w Mieście | Wartość Punktowa (W) |
|---|---|---|---|
| `international_airport` | T0_MEGA_HUB | 1 | 201,776,582 |
| `national_rail_hub` | T0_MEGA_HUB | 1 | 35,107,893 |
| `hospital_clinical` | T1_NATIONAL_MAGNET | 19 | 19,694,609 |
| `national_stadium` | T1_NATIONAL_MAGNET | 9 | 17,167,767 |
| `university_campus` | T1_NATIONAL_MAGNET | 61 | 16,574,744 |
| `regional_rail_hub` | T1_NATIONAL_MAGNET | 8 | 6,685,379 |
| `industrial_zone` | T2_STRATEGIC_HUB | 1210 | 4,034,826 |
| `commercial_zone` | T2_STRATEGIC_HUB | 318 | 3,739,458 |
| `shopping_mall` | T2_STRATEGIC_HUB | 25 | 3,379,112 |
| `logistics_hub` | T2_STRATEGIC_HUB | 4 | 3,275,844 |
| `supermarket` | T2_STRATEGIC_HUB | 148 | 2,595,617 |
| `government_central` | T2_STRATEGIC_HUB | 78 | 2,491,392 |
| `business_office` | T2_STRATEGIC_HUB | 45 | 2,055,180 |
| `education_high_school` | T3_LOCAL_CORE | 157 | 795,703 |
| `marketplace` | T3_LOCAL_CORE | 13 | 701,138 |
| `sports_centre` | T3_LOCAL_CORE | 121 | 631,269 |
| `social_support_mops` | T3_LOCAL_CORE | 28 | 622,022 |
| `culture_theatre` | T3_LOCAL_CORE | 39 | 471,500 |
| `health_clinic` | T3_LOCAL_CORE | 143 | 430,497 |
...
| Kategoria | Tier | Ilość w Mieście | Wartość Punktowa (W) |
|---|---|---|---|
| `national_rail_hub` | T0_MEGA_HUB | 1 | 32,973,823 |
| `national_stadium` | T1_NATIONAL_MAGNET | 6 | 19,164,281 |
| `hospital_clinical` | T1_NATIONAL_MAGNET | 8 | 18,274,065 |
| `university_campus` | T1_NATIONAL_MAGNET | 13 | 17,363,939 |
| `regional_rail_hub` | T1_NATIONAL_MAGNET | 3 | 6,424,288 |
| `industrial_zone` | T2_STRATEGIC_HUB | 164 | 4,762,775 |
| `commercial_zone` | T2_STRATEGIC_HUB | 43 | 4,229,396 |
| `shopping_mall` | T2_STRATEGIC_HUB | 17 | 3,743,038 |
| `government_central` | T2_STRATEGIC_HUB | 29 | 2,667,403 |
| `supermarket` | T2_STRATEGIC_HUB | 80 | 2,464,132 |
| `business_office` | T2_STRATEGIC_HUB | 40 | 2,174,815 |
| `education_high_school` | T3_LOCAL_CORE | 94 | 758,282 |
| `sports_centre` | T3_LOCAL_CORE | 33 | 655,068 |
| `marketplace` | T3_LOCAL_CORE | 8 | 647,798 |
| `social_support_mops` | T3_LOCAL_CORE | 15 | 519,032 |
| `health_clinic` | T3_LOCAL_CORE | 71 | 369,316 |
| `culture_theatre` | T3_LOCAL_CORE | 33 | 367,585 |
...
| Kategoria | Tier | Ilość w Mieście | Wartość Punktowa (W) |
|---|---|---|---|
| `national_stadium` | T1_NATIONAL_MAGNET | 1 | 20,018,644 |
| `hospital_clinical` | T1_NATIONAL_MAGNET | 4 | 18,310,020 |
| `university_campus` | T1_NATIONAL_MAGNET | 6 | 18,065,262 |
| `regional_rail_hub` | T1_NATIONAL_MAGNET | 1 | 6,168,711 |
| `commercial_zone` | T2_STRATEGIC_HUB | 17 | 4,210,444 |
| `industrial_zone` | T2_STRATEGIC_HUB | 299 | 3,749,679 |
| `shopping_mall` | T2_STRATEGIC_HUB | 13 | 3,003,789 |
| `supermarket` | T2_STRATEGIC_HUB | 60 | 2,144,093 |
| `business_office` | T2_STRATEGIC_HUB | 52 | 2,044,749 |
| `government_central` | T2_STRATEGIC_HUB | 27 | 1,881,646 |
| `education_high_school` | T3_LOCAL_CORE | 35 | 858,841 |
| `sports_centre` | T3_LOCAL_CORE | 11 | 673,029 |
| `marketplace` | T3_LOCAL_CORE | 6 | 562,711 |
| `social_support_mops` | T3_LOCAL_CORE | 12 | 512,917 |
| `health_clinic` | T3_LOCAL_CORE | 50 | 371,008 |
| `culture_theatre` | T3_LOCAL_CORE | 15 | 346,139 |
| `education_preschool` | T4_DAILY_SERVICE | 40 | 122,826 |
| `place_of_worship` | T4_DAILY_SERVICE | 38 | 93,265 |
| `park_recreation` | T4_DAILY_SERVICE | 266 | 92,445 |
| `police_station` | T4_DAILY_SERVICE | 4 | 88,517 |
...
| Kategoria | Tier | Ilość w Mieście | Wartość Punktowa (W) |
|---|---|---|---|
| `hospital_clinical` | T1_NATIONAL_MAGNET | 3 | 16,094,391 |
| `university_campus` | T1_NATIONAL_MAGNET | 5 | 11,809,269 |
| `regional_rail_hub` | T1_NATIONAL_MAGNET | 3 | 5,756,276 |
| `industrial_zone` | T2_STRATEGIC_HUB | 71 | 4,152,357 |
| `commercial_zone` | T2_STRATEGIC_HUB | 44 | 4,059,936 |
| `shopping_mall` | T2_STRATEGIC_HUB | 4 | 3,316,312 |
| `supermarket` | T2_STRATEGIC_HUB | 32 | 2,494,145 |
| `business_office` | T2_STRATEGIC_HUB | 8 | 1,721,214 |
| `government_central` | T2_STRATEGIC_HUB | 37 | 1,710,074 |
| `marketplace` | T3_LOCAL_CORE | 3 | 633,478 |
| `education_high_school` | T3_LOCAL_CORE | 47 | 539,677 |
| `sports_centre` | T3_LOCAL_CORE | 30 | 515,174 |
| `social_support_mops` | T3_LOCAL_CORE | 10 | 381,191 |
| `culture_theatre` | T3_LOCAL_CORE | 7 | 310,961 |
| `health_clinic` | T3_LOCAL_CORE | 65 | 293,001 |
...
| Kategoria | Tier | Ilość w Mieście | Wartość Punktowa (W) |
|---|---|---|---|
| `hospital_clinical` | T1_NATIONAL_MAGNET | 1 | 19,583,181 |
| `regional_rail_hub` | T1_NATIONAL_MAGNET | 2 | 5,235,163 |
| `commercial_zone` | T2_STRATEGIC_HUB | 3 | 3,883,342 |
| `industrial_zone` | T2_STRATEGIC_HUB | 13 | 3,859,383 |
| `shopping_mall` | T2_STRATEGIC_HUB | 5 | 2,339,760 |
| `supermarket` | T2_STRATEGIC_HUB | 19 | 1,910,509 |
| `government_central` | T2_STRATEGIC_HUB | 15 | 1,730,719 |
| `business_office` | T2_STRATEGIC_HUB | 3 | 1,479,129 |
| `marketplace` | T3_LOCAL_CORE | 1 | 777,514 |
| `education_high_school` | T3_LOCAL_CORE | 15 | 626,499 |
| `sports_centre` | T3_LOCAL_CORE | 17 | 453,957 |
| `culture_theatre` | T3_LOCAL_CORE | 3 | 406,338 |
| `health_clinic` | T3_LOCAL_CORE | 4 | 366,746 |
| `social_support_mops` | T3_LOCAL_CORE | 1 | 266,293 |
...
| Kategoria | Tier | Ilość w Mieście | Wartość Punktowa (W) |
|---|---|---|---|
| `national_stadium` | T1_NATIONAL_MAGNET | 3 | 20,472,835 |
| `hospital_clinical` | T1_NATIONAL_MAGNET | 4 | 20,416,565 |
| `university_campus` | T1_NATIONAL_MAGNET | 13 | 13,513,149 |
| `regional_rail_hub` | T1_NATIONAL_MAGNET | 2 | 6,136,052 |
| `industrial_zone` | T2_STRATEGIC_HUB | 304 | 3,525,280 |
| `shopping_mall` | T2_STRATEGIC_HUB | 16 | 3,517,469 |
| `commercial_zone` | T2_STRATEGIC_HUB | 255 | 2,809,108 |
| `student_dormitory` | T2_STRATEGIC_HUB | 1 | 2,473,905 |
| `supermarket` | T2_STRATEGIC_HUB | 67 | 2,389,206 |
| `government_central` | T2_STRATEGIC_HUB | 48 | 2,133,168 |
| `business_office` | T2_STRATEGIC_HUB | 18 | 1,534,156 |
| `sports_centre` | T3_LOCAL_CORE | 34 | 643,706 |
| `education_high_school` | T3_LOCAL_CORE | 98 | 633,987 |
| `marketplace` | T3_LOCAL_CORE | 6 | 568,793 |
| `health_clinic` | T3_LOCAL_CORE | 45 | 405,779 |
| `culture_theatre` | T3_LOCAL_CORE | 16 | 380,013 |
| `social_support_mops` | T3_LOCAL_CORE | 4 | 354,987 |
| `park_recreation` | T4_DAILY_SERVICE | 144 | 119,951 |
| `education_preschool` | T4_DAILY_SERVICE | 46 | 116,686 |
| `police_station` | T4_DAILY_SERVICE | 9 | 99,384 |
...
| Kategoria | Tier | Ilość w Mieście | Wartość Punktowa (W) |
|---|---|---|---|
| `international_airport` | T0_MEGA_HUB | 2 | 235,692,182 |
| `national_rail_hub` | T0_MEGA_HUB | 38 | 39,283,836 |
| `national_stadium` | T1_NATIONAL_MAGNET | 115 | 22,944,973 |
| `hospital_clinical` | T1_NATIONAL_MAGNET | 128 | 22,761,064 |
| `university_campus` | T1_NATIONAL_MAGNET | 144 | 18,392,760 |
| `exhibition_centre` | T1_NATIONAL_MAGNET | 1 | 8,542,575 |
| `regional_rail_hub` | T1_NATIONAL_MAGNET | 71 | 7,739,036 |
| `industrial_zone` | T2_STRATEGIC_HUB | 4743 | 4,981,577 |
| `logistics_hub` | T2_STRATEGIC_HUB | 2 | 4,740,327 |
| `commercial_zone` | T2_STRATEGIC_HUB | 2538 | 4,476,156 |
| `shopping_mall` | T2_STRATEGIC_HUB | 219 | 4,345,276 |
| `student_dormitory` | T2_STRATEGIC_HUB | 2 | 4,233,383 |
| `supermarket` | T2_STRATEGIC_HUB | 1267 | 3,139,714 |
| `government_central` | T2_STRATEGIC_HUB | 600 | 2,702,780 |
| `business_office` | T2_STRATEGIC_HUB | 886 | 2,136,091 |
| `marketplace` | T3_LOCAL_CORE | 122 | 885,373 |
| `education_high_school` | T3_LOCAL_CORE | 1646 | 874,784 |
| `sports_centre` | T3_LOCAL_CORE | 838 | 784,842 |
| `social_support_mops` | T3_LOCAL_CORE | 289 | 598,913 |
| `culture_theatre` | T3_LOCAL_CORE | 490 | 461,171 |
...
| Kategoria | Tier | Ilość w Mieście | Wartość Punktowa (W) |
|---|---|---|---|
| `national_rail_hub` | T0_MEGA_HUB | 1 | 27,574,012 |
| `hospital_clinical` | T1_NATIONAL_MAGNET | 1 | 20,547,212 |
| `national_stadium` | T1_NATIONAL_MAGNET | 1 | 17,338,672 |
| `university_campus` | T1_NATIONAL_MAGNET | 2 | 13,302,670 |
| `industrial_zone` | T2_STRATEGIC_HUB | 98 | 4,161,852 |
| `shopping_mall` | T2_STRATEGIC_HUB | 2 | 3,800,226 |
| `commercial_zone` | T2_STRATEGIC_HUB | 3 | 3,666,978 |
| `supermarket` | T2_STRATEGIC_HUB | 20 | 2,480,403 |
| `government_central` | T2_STRATEGIC_HUB | 12 | 2,257,570 |
| `business_office` | T2_STRATEGIC_HUB | 4 | 2,005,394 |
| `social_support_mops` | T3_LOCAL_CORE | 4 | 782,820 |
| `marketplace` | T3_LOCAL_CORE | 2 | 781,811 |
| `education_high_school` | T3_LOCAL_CORE | 19 | 664,111 |
| `sports_centre` | T3_LOCAL_CORE | 10 | 545,391 |
| `culture_theatre` | T3_LOCAL_CORE | 4 | 398,357 |
| `health_clinic` | T3_LOCAL_CORE | 10 | 393,819 |
| `police_station` | T4_DAILY_SERVICE | 2 | 106,090 |
| `education_preschool` | T4_DAILY_SERVICE | 10 | 104,853 |
| `park_recreation` | T4_DAILY_SERVICE | 27 | 103,198 |
| `place_of_worship` | T4_DAILY_SERVICE | 18 | 83,180 |
...
| Kategoria | Tier | Ilość w Mieście | Wartość Punktowa (W) |
|---|---|---|---|
| `national_rail_hub` | T0_MEGA_HUB | 1 | 30,523,427 |
| `hospital_clinical` | T1_NATIONAL_MAGNET | 1 | 26,373,312 |
| `national_stadium` | T1_NATIONAL_MAGNET | 2 | 17,212,092 |
| `university_campus` | T1_NATIONAL_MAGNET | 3 | 16,752,981 |
| `shopping_mall` | T2_STRATEGIC_HUB | 7 | 4,188,458 |
| `industrial_zone` | T2_STRATEGIC_HUB | 155 | 4,084,978 |
| `commercial_zone` | T2_STRATEGIC_HUB | 55 | 3,863,132 |
| `supermarket` | T2_STRATEGIC_HUB | 43 | 2,268,503 |
| `government_central` | T2_STRATEGIC_HUB | 37 | 1,862,318 |
| `business_office` | T2_STRATEGIC_HUB | 18 | 1,709,800 |
| `marketplace` | T3_LOCAL_CORE | 3 | 642,671 |
| `education_high_school` | T3_LOCAL_CORE | 40 | 622,955 |
| `sports_centre` | T3_LOCAL_CORE | 17 | 525,248 |
| `social_support_mops` | T3_LOCAL_CORE | 7 | 429,756 |
| `health_clinic` | T3_LOCAL_CORE | 31 | 325,517 |
| `culture_theatre` | T3_LOCAL_CORE | 24 | 314,821 |
| `park_recreation` | T4_DAILY_SERVICE | 206 | 119,554 |
| `education_preschool` | T4_DAILY_SERVICE | 29 | 104,840 |
| `place_of_worship` | T4_DAILY_SERVICE | 62 | 86,628 |
| `car_services` | T4_DAILY_SERVICE | 21 | 68,649 |
...
| Kategoria | Tier | Ilość w Mieście | Wartość Punktowa (W) |
|---|---|---|---|
| `hospital_clinical` | T1_NATIONAL_MAGNET | 2 | 18,884,406 |
| `national_stadium` | T1_NATIONAL_MAGNET | 4 | 13,327,862 |
| `university_campus` | T1_NATIONAL_MAGNET | 24 | 8,304,633 |
| `regional_rail_hub` | T1_NATIONAL_MAGNET | 1 | 5,907,184 |
| `industrial_zone` | T2_STRATEGIC_HUB | 92 | 4,033,641 |
| `commercial_zone` | T2_STRATEGIC_HUB | 37 | 3,582,780 |
| `shopping_mall` | T2_STRATEGIC_HUB | 11 | 3,237,756 |
| `supermarket` | T2_STRATEGIC_HUB | 46 | 2,061,040 |
| `government_central` | T2_STRATEGIC_HUB | 41 | 1,705,058 |
| `business_office` | T2_STRATEGIC_HUB | 40 | 1,404,981 |
| `marketplace` | T3_LOCAL_CORE | 3 | 632,010 |
| `education_high_school` | T3_LOCAL_CORE | 52 | 579,960 |
| `sports_centre` | T3_LOCAL_CORE | 15 | 434,472 |
| `social_support_mops` | T3_LOCAL_CORE | 8 | 431,070 |
| `culture_theatre` | T3_LOCAL_CORE | 13 | 356,361 |
| `health_clinic` | T3_LOCAL_CORE | 48 | 306,369 |
| `park_recreation` | T4_DAILY_SERVICE | 70 | 119,270 |
| `education_preschool` | T4_DAILY_SERVICE | 40 | 95,273 |
| `place_of_worship` | T4_DAILY_SERVICE | 24 | 90,387 |
| `police_station` | T4_DAILY_SERVICE | 11 | 81,699 |
...
| Kategoria | Tier | Ilość w Mieście | Wartość Punktowa (W) |
|---|---|---|---|
| `international_airport` | T0_MEGA_HUB | 1 | 202,244,577 |
| `national_rail_hub` | T0_MEGA_HUB | 5 | 36,844,943 |
| `hospital_clinical` | T1_NATIONAL_MAGNET | 37 | 21,638,468 |
| `national_stadium` | T1_NATIONAL_MAGNET | 10 | 19,753,405 |
| `university_campus` | T1_NATIONAL_MAGNET | 92 | 18,355,348 |
| `regional_rail_hub` | T1_NATIONAL_MAGNET | 14 | 7,191,061 |
| `industrial_zone` | T2_STRATEGIC_HUB | 1518 | 4,553,753 |
| `shopping_mall` | T2_STRATEGIC_HUB | 75 | 4,177,506 |
| `commercial_zone` | T2_STRATEGIC_HUB | 1162 | 4,033,720 |
| `logistics_hub` | T2_STRATEGIC_HUB | 8 | 3,740,823 |
| `student_dormitory` | T2_STRATEGIC_HUB | 1 | 3,529,691 |
| `supermarket` | T2_STRATEGIC_HUB | 331 | 2,958,400 |
| `government_central` | T2_STRATEGIC_HUB | 180 | 2,422,964 |
| `business_office` | T2_STRATEGIC_HUB | 162 | 1,987,110 |
| `education_high_school` | T3_LOCAL_CORE | 388 | 808,420 |
| `marketplace` | T3_LOCAL_CORE | 46 | 755,155 |
| `social_support_mops` | T3_LOCAL_CORE | 73 | 710,166 |
| `sports_centre` | T3_LOCAL_CORE | 212 | 613,734 |
| `culture_theatre` | T3_LOCAL_CORE | 150 | 432,275 |
| `health_clinic` | T3_LOCAL_CORE | 454 | 387,223 |
...
| Kategoria | Tier | Ilość w Mieście | Wartość Punktowa (W) |
|---|---|---|---|
| `national_stadium` | T1_NATIONAL_MAGNET | 1 | 20,975,707 |
| `hospital_clinical` | T1_NATIONAL_MAGNET | 2 | 20,120,825 |
| `university_campus` | T1_NATIONAL_MAGNET | 3 | 5,560,381 |
| `industrial_zone` | T2_STRATEGIC_HUB | 21 | 4,707,877 |
| `commercial_zone` | T2_STRATEGIC_HUB | 2 | 3,716,745 |
| `shopping_mall` | T2_STRATEGIC_HUB | 6 | 2,969,593 |
| `supermarket` | T2_STRATEGIC_HUB | 32 | 2,120,424 |
| `government_central` | T2_STRATEGIC_HUB | 16 | 1,996,334 |
| `business_office` | T2_STRATEGIC_HUB | 7 | 1,585,718 |
| `education_high_school` | T3_LOCAL_CORE | 32 | 626,365 |
| `sports_centre` | T3_LOCAL_CORE | 6 | 580,630 |
| `marketplace` | T3_LOCAL_CORE | 2 | 551,973 |
| `culture_theatre` | T3_LOCAL_CORE | 5 | 405,803 |
| `health_clinic` | T3_LOCAL_CORE | 10 | 327,611 |
| `social_support_mops` | T3_LOCAL_CORE | 3 | 278,019 |
| `park_recreation` | T4_DAILY_SERVICE | 27 | 123,284 |
| `education_preschool` | T4_DAILY_SERVICE | 33 | 87,423 |
| `place_of_worship` | T4_DAILY_SERVICE | 31 | 75,820 |
| `post_office` | T4_DAILY_SERVICE | 5 | 68,369 |
| `specialized_retail` | T4_DAILY_SERVICE | 28 | 63,039 |
...
| Kategoria | Tier | Ilość w Mieście | Wartość Punktowa (W) |
|---|---|---|---|
| `international_airport` | T0_MEGA_HUB | 1 | 189,835,648 |
| `national_rail_hub` | T0_MEGA_HUB | 1 | 35,520,194 |
| `hospital_clinical` | T1_NATIONAL_MAGNET | 23 | 19,296,910 |
| `national_stadium` | T1_NATIONAL_MAGNET | 10 | 18,073,011 |
| `university_campus` | T1_NATIONAL_MAGNET | 86 | 11,376,795 |
| `regional_rail_hub` | T1_NATIONAL_MAGNET | 4 | 6,878,126 |
| `industrial_zone` | T2_STRATEGIC_HUB | 338 | 4,475,911 |
| `commercial_zone` | T2_STRATEGIC_HUB | 341 | 4,185,058 |
| `shopping_mall` | T2_STRATEGIC_HUB | 35 | 4,010,815 |
| `student_dormitory` | T2_STRATEGIC_HUB | 1 | 3,941,566 |
| `supermarket` | T2_STRATEGIC_HUB | 191 | 2,502,914 |
| `government_central` | T2_STRATEGIC_HUB | 104 | 2,318,897 |
| `business_office` | T2_STRATEGIC_HUB | 95 | 1,940,800 |
| `education_high_school` | T3_LOCAL_CORE | 274 | 609,617 |
| `marketplace` | T3_LOCAL_CORE | 31 | 599,214 |
| `social_support_mops` | T3_LOCAL_CORE | 69 | 524,268 |
| `sports_centre` | T3_LOCAL_CORE | 172 | 499,502 |
| `health_clinic` | T3_LOCAL_CORE | 210 | 372,876 |
| `culture_theatre` | T3_LOCAL_CORE | 84 | 347,748 |
...
| Kategoria | Tier | Ilość w Mieście | Wartość Punktowa (W) |
|---|---|---|---|
| `national_rail_hub` | T0_MEGA_HUB | 1 | 32,761,802 |
| `hospital_clinical` | T1_NATIONAL_MAGNET | 10 | 20,093,611 |
| `national_stadium` | T1_NATIONAL_MAGNET | 5 | 16,723,164 |
| `university_campus` | T1_NATIONAL_MAGNET | 31 | 8,680,958 |
| `regional_rail_hub` | T1_NATIONAL_MAGNET | 5 | 6,304,895 |
| `industrial_zone` | T2_STRATEGIC_HUB | 146 | 4,381,520 |
| `shopping_mall` | T2_STRATEGIC_HUB | 19 | 3,504,912 |
| `commercial_zone` | T2_STRATEGIC_HUB | 48 | 3,429,681 |
| `supermarket` | T2_STRATEGIC_HUB | 84 | 2,284,612 |
| `government_central` | T2_STRATEGIC_HUB | 85 | 2,018,438 |
| `business_office` | T2_STRATEGIC_HUB | 67 | 1,730,519 |
| `education_high_school` | T3_LOCAL_CORE | 79 | 720,184 |
| `marketplace` | T3_LOCAL_CORE | 5 | 693,749 |
| `sports_centre` | T3_LOCAL_CORE | 41 | 568,005 |
| `culture_theatre` | T3_LOCAL_CORE | 26 | 447,955 |
| `social_support_mops` | T3_LOCAL_CORE | 15 | 422,157 |
| `health_clinic` | T3_LOCAL_CORE | 74 | 340,464 |
| `police_station` | T4_DAILY_SERVICE | 13 | 105,380 |
| `education_preschool` | T4_DAILY_SERVICE | 76 | 96,286 |
| `park_recreation` | T4_DAILY_SERVICE | 220 | 95,132 |
...
| Kategoria | Tier | Ilość w Mieście | Wartość Punktowa (W) |
|---|---|---|---|
| `national_rail_hub` | T0_MEGA_HUB | 4 | 30,397,352 |
| `hospital_clinical` | T1_NATIONAL_MAGNET | 8 | 18,366,969 |
| `university_campus` | T1_NATIONAL_MAGNET | 17 | 15,861,781 |
| `national_stadium` | T1_NATIONAL_MAGNET | 3 | 15,820,335 |
| `regional_rail_hub` | T1_NATIONAL_MAGNET | 3 | 6,122,363 |
| `commercial_zone` | T2_STRATEGIC_HUB | 29 | 4,035,910 |
| `industrial_zone` | T2_STRATEGIC_HUB | 316 | 3,999,103 |
| `shopping_mall` | T2_STRATEGIC_HUB | 12 | 3,709,456 |
| `supermarket` | T2_STRATEGIC_HUB | 70 | 2,227,083 |
| `government_central` | T2_STRATEGIC_HUB | 64 | 2,042,857 |
| `business_office` | T2_STRATEGIC_HUB | 24 | 1,877,342 |
| `marketplace` | T3_LOCAL_CORE | 2 | 675,617 |
| `education_high_school` | T3_LOCAL_CORE | 60 | 627,981 |
| `sports_centre` | T3_LOCAL_CORE | 32 | 602,310 |
| `social_support_mops` | T3_LOCAL_CORE | 9 | 420,760 |
| `health_clinic` | T3_LOCAL_CORE | 41 | 378,174 |
| `culture_theatre` | T3_LOCAL_CORE | 14 | 377,308 |
...
| Kategoria | Tier | Ilość w Mieście | Wartość Punktowa (W) |
|---|---|---|---|
| `international_airport` | T0_MEGA_HUB | 1 | 216,085,337 |
| `national_rail_hub` | T0_MEGA_HUB | 3 | 38,693,513 |
| `exhibition_centre` | T1_NATIONAL_MAGNET | 1 | 34,516,845 |
| `national_stadium` | T1_NATIONAL_MAGNET | 29 | 22,718,955 |
| `hospital_clinical` | T1_NATIONAL_MAGNET | 40 | 20,921,035 |
| `university_campus` | T1_NATIONAL_MAGNET | 112 | 14,764,597 |
| `regional_rail_hub` | T1_NATIONAL_MAGNET | 43 | 7,268,448 |
| `industrial_zone` | T2_STRATEGIC_HUB | 2005 | 4,810,949 |
| `logistics_hub` | T2_STRATEGIC_HUB | 6 | 4,630,783 |
| `shopping_mall` | T2_STRATEGIC_HUB | 81 | 4,460,107 |
| `commercial_zone` | T2_STRATEGIC_HUB | 1206 | 4,225,080 |
| `student_dormitory` | T2_STRATEGIC_HUB | 1 | 3,232,893 |
| `supermarket` | T2_STRATEGIC_HUB | 597 | 2,881,830 |
| `government_central` | T2_STRATEGIC_HUB | 300 | 2,267,747 |
| `business_office` | T2_STRATEGIC_HUB | 934 | 1,830,772 |
| `education_high_school` | T3_LOCAL_CORE | 556 | 798,199 |
| `marketplace` | T3_LOCAL_CORE | 48 | 734,117 |
| `sports_centre` | T3_LOCAL_CORE | 351 | 648,669 |
| `social_support_mops` | T3_LOCAL_CORE | 97 | 572,322 |
| `culture_theatre` | T3_LOCAL_CORE | 186 | 426,771 |
...
| Kategoria | Tier | Ilość w Mieście | Wartość Punktowa (W) |
|---|---|---|---|
| `national_rail_hub` | T0_MEGA_HUB | 1 | 29,318,158 |
| `national_stadium` | T1_NATIONAL_MAGNET | 1 | 21,295,950 |
| `hospital_clinical` | T1_NATIONAL_MAGNET | 3 | 18,848,146 |
| `university_campus` | T1_NATIONAL_MAGNET | 7 | 14,546,976 |
| `regional_rail_hub` | T1_NATIONAL_MAGNET | 1 | 5,863,632 |
| `shopping_mall` | T2_STRATEGIC_HUB | 4 | 3,699,379 |
| `commercial_zone` | T2_STRATEGIC_HUB | 68 | 3,253,529 |
| `industrial_zone` | T2_STRATEGIC_HUB | 268 | 2,821,845 |
| `supermarket` | T2_STRATEGIC_HUB | 23 | 2,449,294 |
| `government_central` | T2_STRATEGIC_HUB | 32 | 2,186,349 |
| `business_office` | T2_STRATEGIC_HUB | 13 | 1,948,061 |
| `marketplace` | T3_LOCAL_CORE | 3 | 839,375 |
| `education_high_school` | T3_LOCAL_CORE | 51 | 644,453 |
| `social_support_mops` | T3_LOCAL_CORE | 17 | 639,511 |
| `sports_centre` | T3_LOCAL_CORE | 20 | 585,963 |
| `culture_theatre` | T3_LOCAL_CORE | 16 | 370,754 |
| `health_clinic` | T3_LOCAL_CORE | 38 | 364,278 |
...
| Kategoria | Tier | Ilość w Mieście | Wartość Punktowa (W) |
|---|---|---|---|
| `international_airport` | T0_MEGA_HUB | 1 | 187,095,964 |
| `national_rail_hub` | T0_MEGA_HUB | 1 | 34,018,260 |
| `hospital_clinical` | T1_NATIONAL_MAGNET | 8 | 20,584,630 |
| `national_stadium` | T1_NATIONAL_MAGNET | 9 | 13,772,885 |
| `university_campus` | T1_NATIONAL_MAGNET | 55 | 11,086,126 |
| `regional_rail_hub` | T1_NATIONAL_MAGNET | 2 | 6,696,093 |
| `industrial_zone` | T2_STRATEGIC_HUB | 471 | 4,074,622 |
| `commercial_zone` | T2_STRATEGIC_HUB | 95 | 3,777,887 |
| `shopping_mall` | T2_STRATEGIC_HUB | 30 | 3,498,934 |
| `supermarket` | T2_STRATEGIC_HUB | 72 | 2,563,789 |
| `government_central` | T2_STRATEGIC_HUB | 42 | 2,058,014 |
| `business_office` | T2_STRATEGIC_HUB | 29 | 1,800,087 |
| `marketplace` | T3_LOCAL_CORE | 8 | 829,243 |
| `education_high_school` | T3_LOCAL_CORE | 105 | 796,179 |
| `social_support_mops` | T3_LOCAL_CORE | 21 | 697,057 |
| `sports_centre` | T3_LOCAL_CORE | 50 | 481,671 |
| `culture_theatre` | T3_LOCAL_CORE | 27 | 411,305 |
| `health_clinic` | T3_LOCAL_CORE | 148 | 372,896 |
...
| Kategoria | Tier | Ilość w Mieście | Wartość Punktowa (W) |
|---|---|---|---|
| `international_airport` | T0_MEGA_HUB | 1 | 192,625,979 |
| `national_rail_hub` | T0_MEGA_HUB | 1 | 35,300,120 |
| `hospital_clinical` | T1_NATIONAL_MAGNET | 13 | 20,759,213 |
| `national_stadium` | T1_NATIONAL_MAGNET | 22 | 18,841,940 |
| `university_campus` | T1_NATIONAL_MAGNET | 58 | 11,233,149 |
| `regional_rail_hub` | T1_NATIONAL_MAGNET | 11 | 6,670,940 |
| `industrial_zone` | T2_STRATEGIC_HUB | 650 | 4,315,512 |
| `commercial_zone` | T2_STRATEGIC_HUB | 593 | 3,741,584 |
| `shopping_mall` | T2_STRATEGIC_HUB | 43 | 3,427,518 |
| `logistics_hub` | T2_STRATEGIC_HUB | 1 | 2,307,162 |
| `government_central` | T2_STRATEGIC_HUB | 100 | 2,293,316 |
| `supermarket` | T2_STRATEGIC_HUB | 179 | 2,225,707 |
| `business_office` | T2_STRATEGIC_HUB | 103 | 1,951,095 |
| `marketplace` | T3_LOCAL_CORE | 12 | 737,303 |
| `education_high_school` | T3_LOCAL_CORE | 294 | 674,779 |
| `sports_centre` | T3_LOCAL_CORE | 80 | 659,951 |
| `social_support_mops` | T3_LOCAL_CORE | 31 | 614,440 |
| `culture_theatre` | T3_LOCAL_CORE | 47 | 387,433 |
| `health_clinic` | T3_LOCAL_CORE | 197 | 386,164 |
| `park_recreation` | T4_DAILY_SERVICE | 1376 | 115,249 |
...
| Kategoria | Tier | Ilość w Mieście | Wartość Punktowa (W) |
|---|---|---|---|
| `hospital_clinical` | T1_NATIONAL_MAGNET | 1 | 21,567,111 |
| `university_campus` | T1_NATIONAL_MAGNET | 1 | 18,421,901 |
| `national_stadium` | T1_NATIONAL_MAGNET | 7 | 16,770,392 |
| `regional_rail_hub` | T1_NATIONAL_MAGNET | 2 | 5,712,609 |
| `commercial_zone` | T2_STRATEGIC_HUB | 13 | 4,400,170 |
| `industrial_zone` | T2_STRATEGIC_HUB | 50 | 4,378,219 |
| `shopping_mall` | T2_STRATEGIC_HUB | 11 | 2,908,247 |
| `supermarket` | T2_STRATEGIC_HUB | 33 | 2,357,555 |
| `government_central` | T2_STRATEGIC_HUB | 18 | 2,329,900 |
| `business_office` | T2_STRATEGIC_HUB | 4 | 2,094,740 |
| `marketplace` | T3_LOCAL_CORE | 2 | 937,740 |
| `education_high_school` | T3_LOCAL_CORE | 26 | 685,289 |
| `social_support_mops` | T3_LOCAL_CORE | 2 | 572,112 |
| `culture_theatre` | T3_LOCAL_CORE | 3 | 467,189 |
| `sports_centre` | T3_LOCAL_CORE | 8 | 465,664 |
| `health_clinic` | T3_LOCAL_CORE | 17 | 316,298 |
...
| Kategoria | Tier | Ilość w Mieście | Wartość Punktowa (W) |
|---|---|---|---|
| `national_rail_hub` | T0_MEGA_HUB | 2 | 26,972,109 |
| `hospital_clinical` | T1_NATIONAL_MAGNET | 1 | 17,176,968 |
| `logistics_hub` | T2_STRATEGIC_HUB | 1 | 4,251,739 |
| `industrial_zone` | T2_STRATEGIC_HUB | 33 | 3,946,214 |
| `commercial_zone` | T2_STRATEGIC_HUB | 11 | 3,341,087 |
| `shopping_mall` | T2_STRATEGIC_HUB | 5 | 3,012,545 |
| `student_dormitory` | T2_STRATEGIC_HUB | 1 | 2,990,911 |
| `supermarket` | T2_STRATEGIC_HUB | 19 | 1,872,465 |
| `government_central` | T2_STRATEGIC_HUB | 11 | 1,732,676 |
| `business_office` | T2_STRATEGIC_HUB | 7 | 1,613,329 |
| `education_high_school` | T3_LOCAL_CORE | 15 | 723,892 |
| `marketplace` | T3_LOCAL_CORE | 1 | 699,222 |
| `social_support_mops` | T3_LOCAL_CORE | 4 | 645,504 |
| `sports_centre` | T3_LOCAL_CORE | 4 | 590,529 |
| `culture_theatre` | T3_LOCAL_CORE | 5 | 370,744 |
| `health_clinic` | T3_LOCAL_CORE | 10 | 303,922 |
| `education_preschool` | T4_DAILY_SERVICE | 9 | 118,367 |
| `police_station` | T4_DAILY_SERVICE | 4 | 91,707 |
| `place_of_worship` | T4_DAILY_SERVICE | 12 | 82,178 |
| `park_recreation` | T4_DAILY_SERVICE | 180 | 68,206 |
...
| Kategoria | Tier | Ilość w Mieście | Wartość Punktowa (W) |
|---|---|---|---|
| `international_airport` | T0_MEGA_HUB | 1 | 194,519,659 |
| `national_rail_hub` | T0_MEGA_HUB | 6 | 34,424,373 |
| `hospital_clinical` | T1_NATIONAL_MAGNET | 11 | 25,230,836 |
| `national_stadium` | T1_NATIONAL_MAGNET | 10 | 19,867,213 |
| `university_campus` | T1_NATIONAL_MAGNET | 58 | 12,642,920 |
| `regional_rail_hub` | T1_NATIONAL_MAGNET | 2 | 7,065,724 |
| `industrial_zone` | T2_STRATEGIC_HUB | 591 | 4,297,160 |
| `commercial_zone` | T2_STRATEGIC_HUB | 275 | 4,097,307 |
| `logistics_hub` | T2_STRATEGIC_HUB | 2 | 4,081,989 |
| `shopping_mall` | T2_STRATEGIC_HUB | 40 | 3,840,959 |
| `supermarket` | T2_STRATEGIC_HUB | 207 | 2,576,870 |
| `government_central` | T2_STRATEGIC_HUB | 145 | 2,029,924 |
| `student_dormitory` | T2_STRATEGIC_HUB | 3 | 1,749,742 |
| `business_office` | T2_STRATEGIC_HUB | 315 | 1,668,257 |
| `education_high_school` | T3_LOCAL_CORE | 221 | 707,817 |
| `marketplace` | T3_LOCAL_CORE | 24 | 666,850 |
| `sports_centre` | T3_LOCAL_CORE | 105 | 590,742 |
| `social_support_mops` | T3_LOCAL_CORE | 75 | 512,654 |
| `culture_theatre` | T3_LOCAL_CORE | 57 | 414,766 |
| `health_clinic` | T3_LOCAL_CORE | 356 | 353,723 |
...
| Kategoria | Tier | Ilość w Mieście | Wartość Punktowa (W) |
|---|---|---|---|
| `national_rail_hub` | T0_MEGA_HUB | 1 | 33,846,472 |
| `national_stadium` | T1_NATIONAL_MAGNET | 5 | 19,631,984 |
| `hospital_clinical` | T1_NATIONAL_MAGNET | 18 | 16,646,346 |
| `university_campus` | T1_NATIONAL_MAGNET | 108 | 10,668,791 |
| `regional_rail_hub` | T1_NATIONAL_MAGNET | 6 | 6,490,485 |
| `industrial_zone` | T2_STRATEGIC_HUB | 598 | 3,980,109 |
| `shopping_mall` | T2_STRATEGIC_HUB | 22 | 3,652,231 |
| `commercial_zone` | T2_STRATEGIC_HUB | 516 | 3,493,774 |
| `supermarket` | T2_STRATEGIC_HUB | 112 | 2,300,129 |
| `government_central` | T2_STRATEGIC_HUB | 90 | 1,830,161 |
| `business_office` | T2_STRATEGIC_HUB | 92 | 1,620,485 |
| `education_high_school` | T3_LOCAL_CORE | 111 | 724,465 |
| `marketplace` | T3_LOCAL_CORE | 9 | 585,062 |
| `social_support_mops` | T3_LOCAL_CORE | 40 | 576,804 |
| `sports_centre` | T3_LOCAL_CORE | 71 | 559,555 |
| `culture_theatre` | T3_LOCAL_CORE | 38 | 408,083 |
| `health_clinic` | T3_LOCAL_CORE | 298 | 325,507 |
| `education_preschool` | T4_DAILY_SERVICE | 94 | 112,875 |
| `local_airfield` | T5_SPEC_GASTRO | 1 | 89,742 |
| `place_of_worship` | T4_DAILY_SERVICE | 96 | 88,339 |
...
| Kategoria | Tier | Ilość w Mieście | Wartość Punktowa (W) |
|---|---|---|---|
| `international_airport` | T0_MEGA_HUB | 1 | 204,700,331 |
| `national_rail_hub` | T0_MEGA_HUB | 2 | 37,972,082 |
| `hospital_clinical` | T1_NATIONAL_MAGNET | 17 | 23,646,763 |
| `national_stadium` | T1_NATIONAL_MAGNET | 14 | 22,460,402 |
| `university_campus` | T1_NATIONAL_MAGNET | 62 | 15,715,833 |
| `regional_rail_hub` | T1_NATIONAL_MAGNET | 14 | 7,256,849 |
| `logistics_hub` | T2_STRATEGIC_HUB | 1 | 4,512,587 |
| `shopping_mall` | T2_STRATEGIC_HUB | 91 | 4,008,733 |
| `commercial_zone` | T2_STRATEGIC_HUB | 1072 | 3,949,506 |
| `industrial_zone` | T2_STRATEGIC_HUB | 1931 | 3,884,801 |
| `supermarket` | T2_STRATEGIC_HUB | 315 | 2,686,831 |
| `government_central` | T2_STRATEGIC_HUB | 248 | 2,432,826 |
| `business_office` | T2_STRATEGIC_HUB | 369 | 1,959,206 |
| `education_high_school` | T3_LOCAL_CORE | 354 | 804,985 |
| `marketplace` | T3_LOCAL_CORE | 30 | 779,927 |
| `social_support_mops` | T3_LOCAL_CORE | 84 | 603,099 |
| `sports_centre` | T3_LOCAL_CORE | 217 | 594,888 |
| `culture_theatre` | T3_LOCAL_CORE | 125 | 441,307 |
| `health_clinic` | T3_LOCAL_CORE | 681 | 364,751 |
| `police_station` | T4_DAILY_SERVICE | 50 | 137,890 |
...
| Kategoria | Tier | Ilość w Mieście | Wartość Punktowa (W) |
|---|---|---|---|
| `international_airport` | T0_MEGA_HUB | 2 | 241,001,680 |
| `national_rail_hub` | T0_MEGA_HUB | 6 | 41,216,197 |
| `national_stadium` | T1_NATIONAL_MAGNET | 34 | 25,164,859 |
| `hospital_clinical` | T1_NATIONAL_MAGNET | 75 | 24,157,710 |
| `exhibition_centre` | T1_NATIONAL_MAGNET | 3 | 17,258,706 |
| `university_campus` | T1_NATIONAL_MAGNET | 234 | 14,618,996 |
| `regional_rail_hub` | T1_NATIONAL_MAGNET | 72 | 7,778,172 |
| `shopping_mall` | T2_STRATEGIC_HUB | 175 | 4,920,427 |
| `industrial_zone` | T2_STRATEGIC_HUB | 5113 | 4,540,099 |
| `commercial_zone` | T2_STRATEGIC_HUB | 3934 | 4,417,148 |
| `student_dormitory` | T2_STRATEGIC_HUB | 17 | 3,450,831 |
| `supermarket` | T2_STRATEGIC_HUB | 912 | 2,789,515 |
| `government_central` | T2_STRATEGIC_HUB | 678 | 2,658,806 |
| `business_office` | T2_STRATEGIC_HUB | 1311 | 2,120,538 |
| `logistics_hub` | T2_STRATEGIC_HUB | 19 | 2,094,215 |
| `marketplace` | T3_LOCAL_CORE | 113 | 955,662 |
| `education_high_school` | T3_LOCAL_CORE | 1304 | 807,013 |
| `social_support_mops` | T3_LOCAL_CORE | 282 | 701,824 |
| `sports_centre` | T3_LOCAL_CORE | 843 | 662,023 |
| `culture_theatre` | T3_LOCAL_CORE | 490 | 431,259 |
...
| Kategoria | Tier | Ilość w Mieście | Wartość Punktowa (W) |
|---|---|---|---|
| `international_airport` | T0_MEGA_HUB | 1 | 211,425,590 |
| `national_rail_hub` | T0_MEGA_HUB | 8 | 36,301,104 |
| `national_stadium` | T1_NATIONAL_MAGNET | 10 | 23,706,094 |
| `hospital_clinical` | T1_NATIONAL_MAGNET | 19 | 23,289,410 |
| `university_campus` | T1_NATIONAL_MAGNET | 235 | 10,301,463 |
| `regional_rail_hub` | T1_NATIONAL_MAGNET | 17 | 7,130,686 |
| `student_dormitory` | T2_STRATEGIC_HUB | 1 | 5,515,796 |
| `shopping_mall` | T2_STRATEGIC_HUB | 41 | 4,363,364 |
| `industrial_zone` | T2_STRATEGIC_HUB | 1205 | 4,158,776 |
| `commercial_zone` | T2_STRATEGIC_HUB | 1098 | 4,128,455 |
| `supermarket` | T2_STRATEGIC_HUB | 290 | 2,588,463 |
| `government_central` | T2_STRATEGIC_HUB | 210 | 2,003,377 |
| `business_office` | T2_STRATEGIC_HUB | 428 | 1,863,141 |
| `logistics_hub` | T2_STRATEGIC_HUB | 3 | 1,857,213 |
| `marketplace` | T3_LOCAL_CORE | 20 | 795,192 |
| `education_high_school` | T3_LOCAL_CORE | 463 | 663,647 |
| `sports_centre` | T3_LOCAL_CORE | 218 | 571,588 |
| `social_support_mops` | T3_LOCAL_CORE | 68 | 568,298 |
| `culture_theatre` | T3_LOCAL_CORE | 108 | 399,690 |
| `health_clinic` | T3_LOCAL_CORE | 556 | 366,518 |
...
| Kategoria | Tier | Ilość w Mieście | Wartość Punktowa (W) |
|---|---|---|---|
| `national_rail_hub` | T0_MEGA_HUB | 1 | 31,446,203 |
| `hospital_clinical` | T1_NATIONAL_MAGNET | 2 | 21,159,752 |
| `national_stadium` | T1_NATIONAL_MAGNET | 4 | 18,789,176 |
| `university_campus` | T1_NATIONAL_MAGNET | 14 | 16,144,149 |
| `industrial_zone` | T2_STRATEGIC_HUB | 105 | 4,330,427 |
| `commercial_zone` | T2_STRATEGIC_HUB | 65 | 4,157,771 |
| `shopping_mall` | T2_STRATEGIC_HUB | 27 | 3,517,359 |
| `supermarket` | T2_STRATEGIC_HUB | 67 | 2,518,967 |
| `government_central` | T2_STRATEGIC_HUB | 60 | 2,294,356 |
| `business_office` | T2_STRATEGIC_HUB | 69 | 1,996,856 |
| `education_high_school` | T3_LOCAL_CORE | 43 | 862,538 |
| `sports_centre` | T3_LOCAL_CORE | 89 | 452,672 |
| `social_support_mops` | T3_LOCAL_CORE | 14 | 449,886 |
| `culture_theatre` | T3_LOCAL_CORE | 27 | 411,090 |
| `health_clinic` | T3_LOCAL_CORE | 57 | 369,084 |
